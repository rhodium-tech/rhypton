...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner RHYPTON address\n"
            "  payee          - Print the masternode payout RHYPTON address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting RHYPTON address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "rhypton",               "masternode",             &masternode,             true,  {} },
    { "rhypton",               "masternodelist",         &masternodelist,         true,  {} },
    { "rhypton",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "rhypton",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

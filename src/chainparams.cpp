...
// Copyright (c) 2019 The RHYPTON Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1575617111, nBits=1e0ffff0, nNonce=657975, vtx=1)
...
{
    const char* pszTimestamp = "Business for GenZ";
    const CScript genesisOutputScript = CScript() << ParseHex("047114645f457abc5a9a1fba39898c06a21b9c9604804fe45b5b63b6dd58a9d5fff521bdcef59f76f8c1e5d58b3a77a084d91ed317f69dffc2e96350edeffef498") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000089ec8d903e4bcc5b10bf6a3d6ff7cd2b1fa7446964ccade588e8818551e"); 
        ...
        vAlertPubKey = ParseHex("04e9e177f0493fce30842520960a1a8362c190488447117055b6ce0af12434e59ba3ff2cca1119de792ab2c699d2173ffe61575a7c50923ae3c7ed8c742d22417b");
        nDefaultPort = 14606;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1575617111, 657975, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000089ec8d903e4bcc5b10bf6a3d6ff7cd2b1fa7446964ccade588e8818551e"));
        assert(genesis.hashMerkleRoot == uint256S("0xc3b5b993c34fc2e801661fd306a860854e14e489ac19ca9cdfaf45f3f9a130d3"));
        ...
        // RHYPTON BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // RHYPTON BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // RHYPTON BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"R9JG9gWpcsxrSWzXvaF1LXbUNewheZ5mjq"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x0000089ec8d903e4bcc5b10bf6a3d6ff7cd2b1fa7446964ccade588e8818551e"))
        };

        chainTxData = ChainTxData{
            1575617111, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000e142c86e92ddf8c6786a3f677c43f392dbb3caeacc77c60db2be8c8df63"); 

        pchMessageStart[0] = 0x39;
        pchMessageStart[1] = 0x77;
        pchMessageStart[2] = 0xf0;
        pchMessageStart[3] = 0xa8;
        vAlertPubKey = ParseHex("04a6277f66f99e87cfc7795aef34e76d18cffc50341243689c7c1c0abc1471bc143078c72a9428e55af360209ea588aad25cbbcadc07951affe25decb521ce40e9");
        nDefaultPort = 24606;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1575617116UL, 872368UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000e142c86e92ddf8c6786a3f677c43f392dbb3caeacc77c60db2be8c8df63"));
        assert(genesis.hashMerkleRoot == uint256S("0xc3b5b993c34fc2e801661fd306a860854e14e489ac19ca9cdfaf45f3f9a130d3"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,188);
        // Testnet RHYPTON BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet RHYPTON BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet RHYPTON BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"REXGdAsEL9K5zj83Q4JmRNkcr2PDFt3S47"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000e142c86e92ddf8c6786a3f677c43f392dbb3caeacc77c60db2be8c8df63"))
        };

        chainTxData = ChainTxData{
            1575617116, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1575617121, 5, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x4f535e5391cea62598a561e7bee175d24f7941fbc5e060a9b4940bbb7f2786df"));
        assert(genesis.hashMerkleRoot == uint256S("0xc3b5b993c34fc2e801661fd306a860854e14e489ac19ca9cdfaf45f3f9a130d3"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("rhyptonevo.org",  "devnet-seed.rhyptonevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x4f535e5391cea62598a561e7bee175d24f7941fbc5e060a9b4940bbb7f2786df"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 7KxJUJnof8QYyABzhqmeThah1CTP8ucHVwofHpMPM9f7WGZRdVE
        vSporkAddresses = {"RDDvrjdULpk71jRcuCF81mwTzJfJK17Zv2"};
        nMinSporkKeys = 1;
        ...
        // Regtest RHYPTON addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,60);
        // Regtest RHYPTON script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,61);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,188);
        // Regtest RHYPTON BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest RHYPTON BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest RHYPTON BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;

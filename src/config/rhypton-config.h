/* src/config/rhypton-config.h.  Generated from rhypton-config.h.in by configure.  */
/* src/config/rhypton-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The RHYPTON Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "RHYPTON Core"
...
#define PACKAGE_BUGREPORT "https://github.com/rhyptonpay/rhypton/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RHYPTON Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RHYPTON Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rhyptoncore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://rhypton.org/"

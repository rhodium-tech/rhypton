...
//! These need to be macros, as clientversion.cpp's and rhypton*-res.rc's voodoo requires it
...
/**
 * rhyptond-res.rc includes this file, but it cannot cope with real c++ code.

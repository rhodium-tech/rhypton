...
#define BOOST_TEST_MODULE RHYPTON Test Suite

#include "test_rhypton.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rhypton_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

...
from test_framework.test_framework import RHYPTONTestFramework
...
class LLMQCoinbaseCommitmentsTest(RHYPTONTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as RHYPTONTestFramework doesn't support this atm)

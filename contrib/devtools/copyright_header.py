...
Arguments:
    <base_directory> - The base directory of a RHYPTON Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The RHYPTON Core developers'
...
Arguments:
    <base_directory> - The base directory of RHYPTON Core source code repository.
"""
...
Arguments:
    <file> - A source file in the RHYPTON Core repository.
"""

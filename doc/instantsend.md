...
This mechanism has been integrated into Bitcore-Node-RHYPTON which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rhyptonpay/insight-api-rhypton#web-socket-api](https://github.com/rhyptonpay/insight-api-rhypton#web-socket-api)
* API: [https://github.com/rhyptonpay/insight-api-rhypton#instantsend-transactions](https://github.com/rhyptonpay/insight-api-rhypton#instantsend-transactions)

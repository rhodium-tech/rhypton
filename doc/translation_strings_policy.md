...
This document provides guidelines for internationalization of the RHYPTON Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rhypton_en.ts` remains unchanged.
